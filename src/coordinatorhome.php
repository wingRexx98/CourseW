                    ...
                    <table id="submissionTable" class="table">
                        ...
                        <tbody id="submissionBody">
                            ...
                            <tr>
                                ...
                                <td>30/4/1975</td>
                                <td>
                                    <button type="button" class="btn btn-link buttonComment" data-toggle="modal" data-target="#commentModal" data-row-id="1">
                                        Comment
                                    </button>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>30/4/1975</td>
                                <td>
                                    <button type="button" class="btn btn-link buttonComment" data-toggle="modal" data-target="#commentModal" data-row-id="2">
                                        Comment
                                    </button>
                                </td>
                                <td>
