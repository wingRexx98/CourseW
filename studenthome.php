    ...
    if(isset($_FILES["word"]) && $_FILES["word"]["error"] == 0){
        ...
        if(in_array($filetype, $allowed)){
            ...
            if(file_exists("upload/word/" . $filename)){
                ...
                $sql = "INSERT INTO `r69420`.`submission` (`user_id`, `submission_date`, `word_url`, `image_url`, `publication`) VALUES ('upload/word/".$filename."', 'submit date', 'word url', 'image url', 'publication');";
